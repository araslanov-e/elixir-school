...
```
  ...
  - Если вы не намерены документировать модуль , не оставьте это поле пустым. Лучше установить значение `false`:
...
```
 ...
 - При обращении к функциям внутри документации, используйте обратные кавычки:
